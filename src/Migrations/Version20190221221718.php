 ...
 */
final class Version20190221221718 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_A45BDDC15DA0FB8');
        $this->addSql('CREATE TEMPORARY TABLE __temp__application AS SELECT id, template_id, name, uptime_robot_code FROM application');
        $this->addSql('DROP TABLE application');
        $this->addSql('CREATE TABLE application (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, template_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, uptime_robot_code VARCHAR(255) DEFAULT NULL COLLATE BINARY, automatic BOOLEAN NOT NULL, CONSTRAINT FK_A45BDDC15DA0FB8 FOREIGN KEY (template_id) REFERENCES template (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO application (id, template_id, name, uptime_robot_code) SELECT id, template_id, name, uptime_robot_code FROM __temp__application');
        $this->addSql('DROP TABLE __temp__application');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A45BDDC15DA0FB8 ON application (template_id)');
        ...
        $this->addSql('CREATE INDEX IDX_BF5476CA3E030ACD ON notification (application_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_A45BDDC15DA0FB8');
        $this->addSql('CREATE TEMPORARY TABLE __temp__application AS SELECT id, template_id, name, uptime_robot_code FROM application');
        $this->addSql('DROP TABLE application');
        ...
        $this->addSql('DROP INDEX IDX_BF5476CA497B19F9');
        $this->addSql('DROP INDEX IDX_BF5476CAC54C8C93');
        $this->addSql('DROP INDEX IDX_BF5476CA3E030ACD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__notification AS SELECT id, poster_id, priority_id, type_id, text, start, finish FROM notification');
        $this->addSql('DROP TABLE notification');
